...
// ─────────────────────────────────────────────────────────────────────────────
// AUDIT LOGS  (seed history — pre-runtime events)
// ─────────────────────────────────────────────────────────────────────────────
export const MOCK_AUDIT_LOGS: AuditLog[] = [
  {
    ...
    entityType: 'product',
    entityId: 'p-2',
    entityLabel: 'Linen Blazer',
    actorId: 'admin-1',
    actorName: 'Admin User',
    timestamp: '2026-08-30T14:22:00Z',
    metadata: { field: 'price', from: '$240', to: '$189' },
  },
  {
    id: 'log-2',
  ...
  },
  {
    ...
    entityType: 'customer',
    entityId: 'cust-nora',
    entityLabel: 'nora@example.com',
    actorId: 'admin-1',
    actorName: 'Admin User',
    timestamp: '2026-08-25T16:40:00Z',
    metadata: { reason: 'Account marked inactive' },
  },
  {
    id: 'log-4',
    ...
    entityType: 'order',
    entityId: 'ord-1012',
    entityLabel: 'ord-1012',
    actorId: 'admin-1',
    actorName: 'Admin User',
    timestamp: '2026-08-25T10:00:00Z',
    metadata: { reason: 'Item out of stock after order placement' },
  },
  {
    id: 'log-5',
    action: 'Order Status Changed',
  ...
  },
  {
    ...
    entityType: 'product',
    entityId: 'p-artisan-dinnerware',
    entityLabel: 'Artisan Dinnerware Set',
    actorId: 'admin-1',
    actorName: 'Admin User',
  ...
  },
  {
    ...
    entityType: 'order',
    entityId: 'ord-1014',
    entityLabel: 'ord-1014',
    actorId: 'admin-1',
    actorName: 'Admin User',
    timestamp: '2026-09-01T08:00:00Z',
    metadata: { newStatus: 'out_for_delivery' },
  },
];
